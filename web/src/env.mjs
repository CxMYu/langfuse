...
export const env = createEnv({
  ...
  server: {
    ...
    LANGFUSE_IN_APP_AGENT_SANDBOX_PROVIDER: z
      ...
      .optional(),
    LANGFUSE_IN_APP_AGENT_SANDBOX_DOCKER_IMAGE: z
      .string()
      .default("langfuse-in-app-agent-sandbox:latest"),
    LANGFUSE_IN_APP_AGENT_SANDBOX_LOCAL_SNAPSHOT_DIR: z.string().optional(),
    LANGFUSE_IN_APP_AGENT_SANDBOX_AWS_LAMBDA_ENDPOINT: z.string().optional(),
    LANGFUSE_IN_APP_AGENT_SANDBOX_AWS_LAMBDA_FUNCTION_NAME: z
      .string()
  ...
  runtimeEnv: {
    ...
    LANGFUSE_IN_APP_AGENT_SANDBOX_DOCKER_IMAGE:
      process.env.LANGFUSE_IN_APP_AGENT_SANDBOX_DOCKER_IMAGE,
    LANGFUSE_IN_APP_AGENT_SANDBOX_LOCAL_SNAPSHOT_DIR:
      process.env.LANGFUSE_IN_APP_AGENT_SANDBOX_LOCAL_SNAPSHOT_DIR,
    LANGFUSE_IN_APP_AGENT_SANDBOX_AWS_LAMBDA_ENDPOINT:
      process.env.LANGFUSE_IN_APP_AGENT_SANDBOX_AWS_LAMBDA_ENDPOINT,
    LANGFUSE_IN_APP_AGENT_SANDBOX_AWS_LAMBDA_FUNCTION_NAME:
      process.env.LANGFUSE_IN_APP_AGENT_SANDBOX_AWS_LAMBDA_FUNCTION_NAME,
